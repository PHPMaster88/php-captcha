<?php
    ...
    class captchaConstructor{
        ...
        private function filterOptions(array $options = array()){
            ...
            // ------------------------------------------------------------------------------------------------------- //
            if (is_null($this->wordFont)) {$this->wordFont = $this->paths['main'] . '/data/wordFont.ttf';}
            if (is_null($this->signFont)) {$this->signFont = $this->paths['main'] . '/data/signFont.ttf';}
        }
    }